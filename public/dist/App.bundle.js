...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; // if there's no input on the page, don't run this
  ...
  // if someone hits enter in the address form, don't submit the form
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    var heartCount = (0, _bling.$)('.heart-count').textContent = res.data.hearts.length;
    if (isHearted) {
